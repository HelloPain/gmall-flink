 ...
 * @Function:
 */
public class DwsTradeSkuOrderWindowAsync {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> reduceDs = env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(), "kafka_source")
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> reduceWithSkuDs =
                AsyncDataStream.unorderedWait(reduceDs,
                        new AddDimInfoAsyncFunc<TradeSkuOrderBean, TradeSkuOrderBean>("dim_sku_info") {
                            @Override
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> reduceWithSpuDs = AsyncDataStream.unorderedWait(reduceWithSkuDs,
                new AddDimInfoAsyncFunc<TradeSkuOrderBean, TradeSkuOrderBean>("dim_spu_info") {
                    @Override
                    public String getPk(TradeSkuOrderBean input) {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> reduceWithTmDs = AsyncDataStream.unorderedWait(reduceWithSpuDs,
                new AddDimInfoAsyncFunc<TradeSkuOrderBean, TradeSkuOrderBean>("dim_base_trademark") {
                    @Override
                    public String getPk(TradeSkuOrderBean input) {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> reduceWithC3DS = AsyncDataStream.unorderedWait(reduceWithTmDs,
                new AddDimInfoAsyncFunc<TradeSkuOrderBean, TradeSkuOrderBean>("dim_base_category3") {
                    @Override
                    public String getPk(TradeSkuOrderBean input) {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> reduceWithC2DS = AsyncDataStream.unorderedWait(reduceWithC3DS,
                new AddDimInfoAsyncFunc<TradeSkuOrderBean, TradeSkuOrderBean>("dim_base_category2") {
                    @Override
                    public String getPk(TradeSkuOrderBean input) {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> reduceWithC1DS = AsyncDataStream.unorderedWait(reduceWithC2DS,
                new AddDimInfoAsyncFunc<TradeSkuOrderBean, TradeSkuOrderBean>("dim_base_category1") {
                    @Override
                    public String getPk(TradeSkuOrderBean input) {
